    ...
    <div id="page" class="stylehome1 h0">
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-left">
                    ...
                    <span class="mt15">aga-Community</span>
                </div>
        ...
        <nav id="menu" class="stylehome1">
            <ul>
                <li><span>공방</span>
                    <ul>
                        <li><a href="index.html">장소 리뷰</a></li>
                        <li><a href="index2.html">예약 하기</a></li>
                        <li><a href="index3.html">저장한 장소</a></li>
                    </ul>
                </li>
                <li><span>마이페이지</span>
                    <ul>
                        <li><a href="page-author-single.html">프로필 수정하기</a></li>
                        <li><a href="page-city-single.html">""</a></li>
                    </ul>
                </li>
                <li><span>분리수거 방법</span>
                    <ul>
                ...
                <div class="col-lg-12">
                    <div class="ed_menu_list mt5">
                        <ul>
                            ...
                            <li><a class="active" href="page-my-bookmark.html"><span class="flaticon-love"></span> Bookmarks</a></li>
            ...
            <div class="row">
                    ...
                    <div class="dashboard_navigationbar dn db-992">
                        <div class="dropdown">
                            ...
                            <ul id="myDropdown" class="dropdown-content">
                                ...
                                <li><a href="page-my-listing.html"><span class="flaticon-list"></span> My Listings</a></li>
                                <li class="active"><a href="page-my-bookmark.html"><span class="flaticon-love"></span> Bookmarks</a></li>
                                <li><a href="page-message.html"><span class="flaticon-chat"></span> Message</a></li>
                                <li><a href="page-my-review.html"><span class="flaticon-note"></span> Reviews</a></li>
                ...
                <div class="col-lg-12 mb15">
                    <div class="breadcrumb_content style2">
                        <h2 class="breadcrumb_title float-left">Bookmarks</h2>
